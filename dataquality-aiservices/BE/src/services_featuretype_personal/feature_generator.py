...
pkl_name_path = os.path.join(BASE_DIR, "dictionaryName.pkl")
pkl_sample_path = os.path.join(BASE_DIR, "dictionarySample.pkl")

vectorizerName = joblib.load(pkl_name_path)
vectorizerSample = joblib.load(pkl_sample_path)
